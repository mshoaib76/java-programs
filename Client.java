...
public class Client  implements ActionListener {
    ...
    Client(){
       ...
       f. setLayout(null);
        ...
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("icons/dpA.jpg"));  // profile image
        ...
        dotes.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                // Add action listeners for other menu items if needed
